...
$offcanvas-bg-color: rgb(212, 206, 255);
$offcanvas-color: red;
...
.accordion{
  border: 2px solid $offcanvas-bg-color;
  border-radius: 20px;
...
html { 
    ...
    background-image: linear-gradient( 109.6deg, rgba(156,252,248,1) 11.2%, rgb(137, 214, 255) 91.1% );
